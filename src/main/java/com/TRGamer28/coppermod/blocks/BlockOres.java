...
public class BlockOres extends Block implements IHasModel, IMetaName
{
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        ...
        {
            return ModBlocks.COPPER_ORE.getItemDropped(ModBlocks.COPPER_ORE.getDefaultState(), rand, fortune);
        }
        else if (this == ModBlocks.SILVER_ORE)
        {
            return ModBlocks.SILVER_ORE.getItemDropped(ModBlocks.SILVER_ORE.getDefaultState(), rand, fortune);
        }
        else if (this == ModBlocks.COPPER_ORE)
        {
            return ModBlocks.TIN_ORE.getItemDropped(ModBlocks.TIN_ORE.getDefaultState(), rand, fortune);
        }
        else if (this == ModBlocks.LIMESTONE)
        {
            return ModBlocks.LIMESTONE.getItemDropped(ModBlocks.LIMESTONE.getDefaultState(), rand, fortune);
        }
		return null;
