...
import com.TRGamer28.coppermod.blocks.AlloyFurnace.slots.SlotAlloyFurnaceFuel;
import com.TRGamer28.coppermod.blocks.AlloyFurnace.slots.SlotAlloyFurnaceOutput;
...
public class ContainerAlloyFurnace extends Container
{
	...
	public ContainerAlloyFurnace(InventoryPlayer player, TileEntityAlloyFurnace tileentity) 
	{
		...
		this.addSlotToContainer(new SlotAlloyFurnaceFuel(tileentity, 2, 7, 35));
		this.addSlotToContainer(new SlotAlloyFurnaceOutput(player.player, tileentity, 3, 81, 36));
