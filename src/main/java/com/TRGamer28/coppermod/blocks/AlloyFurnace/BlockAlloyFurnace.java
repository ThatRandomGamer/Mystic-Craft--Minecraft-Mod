package com.TRGamer28.coppermod.blocks.AlloyFurnace;
...
import com.TRGamer28.coppermod.util.handlers.ConfigHandler;
...
public class BlockAlloyFurnace extends BlockBase implements ITileEntityProvider
{
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) 
	{
		...
		if(active) worldIn.setBlockState(pos, ModBlocks.ALLOY_FURNACE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, true), 3);
		else worldIn.setBlockState(pos, ModBlocks.ALLOY_FURNACE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, false), 3);
