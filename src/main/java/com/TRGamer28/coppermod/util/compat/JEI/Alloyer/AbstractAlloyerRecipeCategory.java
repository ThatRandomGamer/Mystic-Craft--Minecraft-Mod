...
public abstract class AbstractAlloyerRecipeCategory<T extends IRecipeWrapper> implements IRecipeCategory<T>
{
    ...
    public AbstractAlloyerRecipeCategory(IGuiHelper helper) 
    {
